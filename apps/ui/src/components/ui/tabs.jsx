...
const TabsTrigger = React.forwardRef(({ className, ...props }, ref) => (
    <TabsPrimitive.Trigger
        ref={ref}
        className={cn(
            'inline-flex h-[26px] items-center justify-center gap-1 whitespace-nowrap rounded-[7px] px-4 text-callout font-medium transition-[background-color,color,box-shadow] duration-200 ease-out',
